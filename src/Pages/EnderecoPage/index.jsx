...
const EnderecoPage = () => {
  ...
  const consultarCEP = async () => {
    try {
      ...
      console.error("Um erro aconteceu ao buscar o CEP");
    }
  };
  ...
  return (
    <Box
      ...
      gap={3}
      width="100vw"
      className="endereco-page" // Adiciona a classe do arquivo CSS
    >
      ...
      <Stack alignItems="center" gap={1} direction="row">
        ...
        />
        <Button variant="contained" onClick={() => consultarCEP()} className="rosa">
          Buscar
        </Button>
      </Stack>
